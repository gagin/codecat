...
[Unreleased]: https://github.com/gagin/codecat/compare/v0.5.1...HEAD
[0.5.1]: https://github.com/gagin/codecat/compare/v0.5.0...v0.5.1
[0.5.0]: https://github.com/gagin/codecat/compare/v0.4.3...v0.5.0
[0.4.3]: https://github.com/gagin/codecat/compare/v0.4.2...v0.4.3
[0.4.2]: https://github.com/gagin/codecat/compare/v0.4.1...v0.4.2
[0.4.1]: https://github.com/gagin/codecat/compare/v0.4.0...v0.4.1
[0.4.0]: https://github.com/gagin/codecat/compare/v0.3.0...v0.4.0
[0.3.0]: https://github.com/gagin/codecat/releases/tag/v0.3.0

## [0.5.1] - 2025-07-24

### Added

-   **Excluded Files in Debug Summary:** When running with `--loglevel=debug`, the summary will now include a new section listing all files that were discovered but excluded by any rule (`.gitignore`, `exclude_basenames`, etc.). This provides complete visibility into what the tool is ignoring, which is useful for debugging configuration issues.

### Fixed

-   **CRITICAL: `-f/--files` Priority:** Fixed a major bug where files specified with `-f` could still be excluded by `.gitignore` rules or other exclusion mechanisms. The `-f` flag now has the highest priority and will always include the specified files, regardless of any other exclusion rules.
-   Fixed a bug in the test suite's `awk` script that caused it to fail when parsing test files with only a single code block.
